...
uint16_t S0_TX_getFreeSize(void)
{
	...
	uint16_t word_TX_FSR = socket0_TX_FSR[0];
	return (word_TX_FSR << 8 ) | (uint16_t)socket0_TX_FSR[1];
}
uint16_t S1_TX_getFreeSize(void)
{
	...
	uint16_t word_TX_FSR = socket1_TX_FSR[0];
	return (word_TX_FSR << 8 ) | (uint16_t)socket1_TX_FSR[1];
}
uint16_t S2_TX_getFreeSize(void)
{
	...
	uint16_t word_TX_FSR = socket2_TX_FSR[0];
	return (word_TX_FSR << 8 ) | (uint16_t)socket2_TX_FSR[1];
}
uint16_t S3_TX_getFreeSize(void)
{
	...
	uint16_t word_TX_FSR = socket3_TX_FSR[0];
	return (word_TX_FSR << 8 ) | (uint16_t)socket3_TX_FSR[1];
}
...
uint16_t S0_TX_getWriteAddress(void)
{
	...
	uint16_t word_TX_WR = socket0_TX_WR[0];
	return (word_TX_WR << 8 ) | (uint16_t)socket0_TX_WR[1];
}
uint16_t S1_TX_getWriteAddress(void)
{
	...
	uint16_t word_TX_WR = socket1_TX_WR[0];
	return (word_TX_WR << 8 ) | (uint16_t)socket1_TX_WR[1];
}
uint16_t S2_TX_getWriteAddress(void)
{
	...
	uint16_t word_TX_WR = socket2_TX_WR[0];
	return (word_TX_WR << 8 ) | (uint16_t)socket2_TX_WR[1];
}
uint16_t S3_TX_getWriteAddress(void)
{
	...
	uint16_t word_TX_WR = socket3_TX_WR[0];
	return (word_TX_WR << 8 ) | (uint16_t)socket3_TX_WR[1];
}
uint16_t S0_RX_getReadAddress(void)
{
	...
	uint16_t word_RX_RD = socket0_RX_RD[0];
	return (word_RX_RD << 8 ) | (uint16_t)socket0_RX_RD[1];
}
uint16_t S1_RX_getReadAddress(void)
{
	...
	uint16_t word_RX_RD = socket1_RX_RD[0];
	return (word_RX_RD << 8 ) | (uint16_t)socket1_RX_RD[1];
}
uint16_t S2_RX_getReadAddress(void)
{
	...
	uint16_t word_RX_RD = socket2_RX_RD[0];
	return (word_RX_RD << 8 ) | (uint16_t)socket2_RX_RD[1];
}
uint16_t S3_RX_getReadAddress(void)
{
	...
	uint16_t word_RX_RD = socket3_RX_RD[0];
	return (word_RX_RD << 8 ) | (uint16_t)socket3_RX_RD[1];
}
uint16_t S0_RX_getReceivedSize(void)
{
	...
	uint16_t word_RX_RSR = socket0_RX_RSR[0];
	return (word_RX_RSR << 8) | (uint16_t)socket0_RX_RSR[1];
}
uint16_t S1_RX_getReceivedSize(void)
{
	...
	uint16_t word_RX_RSR = socket1_RX_RSR[0];
	return (word_RX_RSR << 8) | (uint16_t)socket1_RX_RSR[1];
}
uint16_t S2_RX_getReceivedSize(void)
{
	...
	uint16_t word_RX_RSR = socket2_RX_RSR[0];
	return (word_RX_RSR << 8) | (uint16_t)socket2_RX_RSR[1];
}
uint16_t S3_RX_getReceivedSize(void)
{
	...
	uint16_t word_RX_RSR = socket3_RX_RSR[0];
	return (word_RX_RSR << 8) | (uint16_t)socket3_RX_RSR[1];
}